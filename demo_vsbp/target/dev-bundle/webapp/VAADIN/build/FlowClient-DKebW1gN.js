function init() {
  function client() {
    var Jb = "", Kb = 0, Lb = "gwt.codesvr=", Mb = "gwt.hosted=", Nb = "gwt.hybrid", Ob = "client", Pb = "#", Qb = "?", Rb = "/", Sb = 1, Tb = "img", Ub = "clear.cache.gif", Vb = "baseUrl", Wb = "script", Xb = "client.nocache.js", Yb = "base", Zb = "//", $b = "meta", _b = "name", ac = "gwt:property", bc = "content", cc = "=", dc = "gwt:onPropertyErrorFn", ec = 'Bad handler "', fc = '" for "gwt:onPropertyErrorFn"', gc = "gwt:onLoadErrorFn", hc = '" for "gwt:onLoadErrorFn"', ic = "user.agent", jc = "webkit", kc = "safari", lc = "msie", mc = 10, nc = 11, oc = "ie10", pc = 9, qc = "ie9", rc = 8, sc = "ie8", tc = "gecko", uc = "gecko1_8", vc = 2, wc = 3, xc = 4, yc = "Single-script hosted mode not yet implemented. See issue ", zc = "http://code.google.com/p/google-web-toolkit/issues/detail?id=2079", Ac = "17C68BB52CBFCD9B8229B9E49E6E39FE", Bc = ":1", Cc = ":", Dc = "DOMContentLoaded", Ec = 50;
  ...
  (function() {
    ...
    function CC(a) {
      ...
      b2 = MC(a, a.indexOf("android ") + 8, a.length);
      b2 = MC(b2, 0, b2.indexOf(";"));
      c2 = $E(b2, "\\.");
      HC(c2, a);
    }
    function GC(a) {
    ...
    function KC(b2) {
      var c2, d2, e2, f2, g2, h2;
      b2 = b2.toLowerCase();
      this.f = b2.indexOf("gecko") != -1 && b2.indexOf("webkit") == -1 && b2.indexOf(qJ) == -1;
      b2.indexOf(" presto/") != -1;
      this.l = b2.indexOf(qJ) != -1;
      this.m = !this.l && b2.indexOf("applewebkit") != -1;
      this.c = (b2.indexOf(" chrome/") != -1 || b2.indexOf(" crios/") != -1 || b2.indexOf(pJ) != -1) && b2.indexOf(rJ) == -1;
      this.j = b2.indexOf("opera") != -1 || b2.indexOf(rJ) != -1;
      ...
      if (b2.indexOf(" edge/") != -1 || b2.indexOf(" edg/") != -1 || b2.indexOf(sJ) != -1 || b2.indexOf(tJ) != -1) {
        this.d = true;
        this.c = false;
        this.j = false;
        this.g = false;
      ...
      try {
        if (this.g) {
          ...
          e2 = b2.indexOf(" version/");
          e2 != -1 ? e2 += 9 : b2.indexOf(rJ) != -1 ? e2 = b2.indexOf(rJ) + 5 : e2 = b2.indexOf("opera/") + 6;
          JC(this, MC(b2, e2, e2 + LC(b2, e2)), b2);
        } else if (this.d) {
          e2 = b2.indexOf(" edge/") + 6;
          b2.indexOf(" edg/") != -1 ? e2 = b2.indexOf(" edg/") + 5 : b2.indexOf(sJ) != -1 ? e2 = b2.indexOf(sJ) + 6 : b2.indexOf(tJ) != -1 && (e2 = b2.indexOf(tJ) + 8);
          JC(this, MC(b2, e2, e2 + LC(b2, e2)), b2);
        }
      } catch (a) {
        a = Mi(a);
    ...
    var NC, OC, PC, QC;
    var Ch = fE(wJ, "Dependency/Type", 45, TC);
    var UC;
    Vi(44, 20, { 44: 1, 4: 1, 31: 1, 20: 1 }, $C);
    var WC, XC, YC;
    var Dh = fE(wJ, "LoadMode", 44, _C);
    Vi(115, 1, TI, pD);
    _2.Fb = function qD() {
    ...
    eE(bJ, "Timer/2", 309);
    Vi(324, 1, {});
    eE(xJ, "OutputStream", 324);
    Vi(325, 324, {});
    eE(xJ, "FilterOutputStream", 325);
    Vi(125, 325, {}, LD);
    eE(xJ, "PrintStream", 125);
    Vi(83, 1, { 111: 1 });
    _2.q = function ND() {
      return this.a;
    };
    ...
    _2.a = 0;
    eE(zJ, "AbstractList/IteratorImpl", 133);
    ...
    _2.a = 0;
    _2.b = -1;
    eE(zJ, "ArrayList/1", 70);
    Vi(151, 10, HH, TF);
    eE(zJ, "NoSuchElementException", 151);
    Vi(53, 1, { 53: 1 }, $F);
    _2.n = function _F(a) {
      var b2;
      if (a === this) {
    ...
    _2.c = 0;
    _2.d = 0;
    eE(zJ, "Spliterators/BaseSpliterator", 139);
    Vi(140, 139, {});
    eE(zJ, "Spliterators/AbstractSpliterator", 140);
    Vi(136, 1, {});
    _2.hc = function nG(a) {
      dG(this, a);
    };
    ...
    _2.c = 0;
    _2.d = 0;
    eE(zJ, "Spliterators/BaseArraySpliterator", 136);
    Vi(137, 136, {}, pG);
    _2.hc = function qG(a) {
      jG(this, a);
    };
    ...
    eE(zJ, "Spliterators/ArraySpliterator", 137);
    Vi(123, 1, {}, tG);
    _2.q = function uG() {
      return !this.a ? this.c : this.e.length == 0 ? this.a.a : this.a.a + ("" + this.e);
    };
    eE(zJ, "StringJoiner", 123);
    Vi(110, 1, TH, vG);
    _2.V = function wG(a) {
      return a;
    };
    ...
    var yG, zG, AG;
    var zi = fE(AJ, "Collector/Characteristics", 49, DG);
    Vi(291, 1, {}, EG);
    eE(AJ, "CollectorImpl", 291);
    Vi(108, 1, WH, GG);
    _2.cb = function HG(a, b2) {
      FG(a, b2);
    };
    eE(AJ, "Collectors/20methodref$add$Type", 108);
    Vi(107, 1, UH, IG);
    _2.bb = function JG() {
      return new GF();
    };
    eE(AJ, "Collectors/21methodref$ctor$Type", 107);
    Vi(109, 1, {}, KG);
    eE(AJ, "Collectors/lambda$42$Type", 109);
    Vi(138, 1, {});
    _2.c = false;
    eE(AJ, "TerminatableStream", 138);
    Vi(96, 138, {}, SG);
    eE(AJ, "StreamImpl", 96);
    Vi(141, 140, {}, WG);
    _2.ic = function XG(a) {
    ...
    eE(AJ, "StreamImpl/MapToObjSpliterator", 141);
    Vi(143, 1, {}, YG);
    _2.gb = function ZG(a) {
      VG(this.a, this.b, a);
    };
    eE(AJ, "StreamImpl/MapToObjSpliterator/lambda$0$Type", 143);
    Vi(142, 1, {}, _G);
    _2.gb = function aH(a) {
      $G(this, a);
    };
    eE(AJ, "StreamImpl/ValueConsumer", 142);
    Vi(144, 1, {}, cH);
    eE(AJ, "StreamImpl/lambda$4$Type", 144);
    Vi(145, 1, {}, dH);
    _2.gb = function eH(a) {
      UG(this.b, this.a, a);
    };
    eE(AJ, "StreamImpl/lambda$5$Type", 145);
    Vi(482, 1, {});
    Vi(479, 1, {});
    var qH = 0;
    var sH, tH = 0, uH;
    ...
    Pi(_i);
    Si("permProps", [[[DJ, "gecko1_8"]], [[DJ, "safari"]]]);
